                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <?php if (mysqli_num_rows($userHasEvent) < 1) : ?>
                            <tr class="text-center text-secondary">
                                <td colspan="6">Belum mengikuti event. <a href="/user/event/">Daftar sekarang</a></td>
                            </tr>
                        <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <?php } elseif ($row['status'] == 'acc') { ?>
                                    <?php if (date('Y-m-d') > $row['tanggal_mulai']) { ?>
                                        ...
                                        <td>
                                            <a href="sertifikat/index.php?id=<?= $row['idEvent'] ?>" class="btn btn-dark btn-sm" download>
                                                Download
                                            </a>
                                        </td>
                                    <?php } else { ?>
